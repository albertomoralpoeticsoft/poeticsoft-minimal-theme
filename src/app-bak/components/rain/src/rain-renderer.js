...
import shadervert from './shaders/simple.vert.js'
import shaderfrag from './shaders/water.frag.js'
import requireShaderScript from "glslify";

let vertShader = requireShaderScript(shadervert);
let fragShader = requireShaderScript(shaderfrag);
